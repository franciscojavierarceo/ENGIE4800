# -*- coding: utf-8 -*-
"""
Created on Mon Dec  7 22:22:04 2015
...
def ParseXML(filenames,inpth,opth):
    ...
    fp = open(opth+'2014_GS_ModelData.csv', 'w')
                ...
                if x=='<?xml version="1.0" encoding="UTF-8"?>':
                    ...
                    if CheckUtility(soup):
                        try:
                            ...
                            print 'writing patent ' + patent_id + ' to GS_ModelData.csv'
                        except:
                            pass
                    soup.decompose()
                    chunk=line
...
if __name__ == '__main__':
    ...
    inpth = '/Volumes/MyMac/ENGIE4800/Data/2014/'
    outpth = '/Users/franciscojavierarceo/GitHub/patents/Data/2014/'
